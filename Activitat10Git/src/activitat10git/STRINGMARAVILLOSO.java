...
public class STRINGMARAVILLOSO {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("LA versió que tenim a github ha estat actualitzada "
                + "i és mes actual que la que tinc en local");
        
        
        STRINGMARAVILLOSO.generarPartSuperior();
        STRINGMARAVILLOSO.generarPartInferior();
    ...
    public static void generarPartInferior() {
